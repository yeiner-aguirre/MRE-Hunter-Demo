...
export default function NotFoundPage() {
  return (
    <section className="container-shell py-12 sm:py-16">
      <div className="surface-card overflow-hidden px-6 py-12 text-center sm:px-10 sm:py-16">
        ...
        <p className="mx-auto mt-5 max-w-2xl text-base leading-8 text-white/68 sm:text-lg">
          La estructura esta lista para seguir creciendo, pero esta pantalla aun
          no forma parte de la demo final.
        </p>
